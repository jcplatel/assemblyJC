...
% --- Chargement des données (à décommenter selon votre usage) ---
% load('Race.mat')
% load('Clusters.mat')   % Contient IDX2
% load('NClustersOK.mat') % Contient NClOK
% load('TRace')
...
P_VAL_THRESHOLD = 0.01;   % Seuil relaxé (pas de correction Bonferroni ici)
MIN_CELL_SIZE = 10;        % Nombre min de cellules pour former une assemblée
