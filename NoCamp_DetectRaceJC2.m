...
plane1=readNPY('/Users/platel/Desktop/exp/erwan/suite2p_230215_230302_12_230307_plane1/F.npy');
iscell0=readNPY('/Users/platel/Desktop/exp/erwan/suite2p_230215_230302_12_230307_plane0/iscell.npy');
iscell1=readNPY('/Users/platel/Desktop/exp/erwan/suite2p_230215_230302_12_230307_plane1/iscell.npy');
...
[IDX2,sCl,M,S] = kmeansopt(Race,10,'var');%increase to 50,  100 ?
% M = CovarM(Race);
% IDX2 = kmedoids(M,NCl);
NCl = max(IDX2);
