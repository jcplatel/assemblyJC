...
for i=1:NCell    
    th=3*iqr(Tr1b(i,:));
    %th(i)=3*std(Tr1b(i,:));
    [amplitude,locs] = findpeaks(Tr1b(i,:),'MinPeakProminence',th,'MinPeakDistance',MinPeakDistance);
...
for z=1:5
    ...
    exportgraphics(gcf,[namefull 'activityall.png'],'Resolution',300)
...
%write list of cells in each cluster
    ...
    parfor i = 1:kmeans_surrogate  %increase to 1000 ???
